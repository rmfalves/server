                                                ...
                                                bool replace_flag)
{
  ...
  if (ddl_log_write_entry(&ddl_log_entry, &first_entry))
  {
error:
  ...
  if (ddl_log_write_execute_entry(first_entry->entry_pos, &exec_entry))
    goto error;
...
void FK_backup_storage::rollback(THD *thd)
{
  ...
  if (ddl_log_execute_entry(thd, first_entry->entry_pos))
  {
