...
static void bg_wsrep_kill_trx(void *void_arg)
{
	...
	THD *bf_thd 		   = find_thread_by_id(arg->bf_thd_id);
	THD *thd 		   = find_thread_by_id(arg->thd_id);
	...
	if (wsrep_thd_bf_abort(bf_thd, thd, arg->signal))
	{
